...
public final class VirtualWorld extends PApplet {
    ...
    */
    ...
    public void mousePressed() {
        ...
        Optional<EntityInterface> entityOptional = world.getOccupant(pressed);
        if (entityOptional.isPresent()) {
            EntityInterface entity = entityOptional.get();
    ...
    public void scheduleActions(WorldModel world, EventScheduler scheduler, ImageStore imageStore) {
        for (EntityInterface entity : world.getEntities()) {
            switch (entity.getKind()) {
                case "DUDE_FULL", "DUDE_NOT_FULL", "OBSTACLE", "FAIRY", "SAPLING", "TREE":
                    ScheduleAction temp_entity = (ScheduleAction) entity;
                    temp_entity.scheduleActions(scheduler, world, imageStore);
                    break;
                default:
            }
        }
